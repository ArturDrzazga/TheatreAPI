# Generated by Django 6.0 on 2026-01-19 14:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='performance',
            constraint=models.UniqueConstraint(fields=('theatre_hall', 'show_time'), name='unique_performance_hall_time'),
        ),
        migrations.AddConstraint(
            model_name='performance',
            constraint=models.UniqueConstraint(fields=('play', 'show_time'), name='unique_performance_play_time'),
        ),
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'performance'), name='unique_ticket_seat_performance'),
        ),
    ]
